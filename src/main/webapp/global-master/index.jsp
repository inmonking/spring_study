      ...
      <div class="l-wrapper">
        <header class="header">
          ...
          <div class="header--nav-toggle">
            <!-- <span></span> -->
            <a href="<%=request.getContextPath() %>/view/main.jsp">
          ...
          <li class="l-section section section--is-active">
            <div class="intro">
              ...
              <div class="intro--options"
                ...
                <a href="#0">
                  <h2>영화   &amp; 공연/전시</h2>
                  <p style="font-size: 13pt;">당신이 원하는 문화생활을 <br>원하는 시간에 즐길 수 있게</p>
                </a>
                <a href="#0">
                  <h2>항공권</h2>
                  <p style="font-size: 13pt;">당신이 가고 싶은 여행지를 <br>원하는 가격에 갈 수 있게</p>
                </a>
                <a href="#0">
                  <h2>쇼핑</h2>
                  <p style="font-size: 13pt;">당신이 원하는 물건을 <br>원하는 가격에 살 수 있게</p>
                </a>
              </div>
            </div>
          </li>
